...
export default function ReferFriendModal({ isOpen, onClose }) {
  ...
  const handleShare = async () => {
    if (inviteCode) {
      const shareText = `Join HY3N as a driver with my invite code ${inviteCode.invite_code} and get GH₵10 bonus after your first trip! I'll also get GH₵15 when you complete it. 🚗💰`;
      
      if (navigator.share) {
        try {
          await navigator.share({
            title: 'HY3N Driver Referral',
            text: shareText,
          });
        } catch (error) {
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-lg">Refer a Driver</h3>
                    <p className="text-xs text-muted-foreground">Earn GH₵15 per driver</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-4 mb-6">
                ...
                <ul className="text-xs text-muted-foreground space-y-1">
                  ...
                  <li>• Friend signs up as driver & completes first trip</li>
